...
cd $DIR
squeue -u jp3h | sort
SLURMOUT_GRAPE=slurm-25953246_*.out
SLURMOUT_LUCERNE=slurm-25953247_*.out
SLURMOUT_SOYBEAN=slurm-25953248_*.out
tail slurm-2595324*_*.out
grep -n -i "err" slurm-2595324*_*.out | grep -v "mean absolute"
